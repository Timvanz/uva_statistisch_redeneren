...
# File: 3.py
#
# This program plots the probability distribution function and cumulative
# distribution function from the normal distribution. Then takes 1000 values
# from the normal distribution and forms a histogram from those values.
# 
# -----------------------------------------------------------------------------
...
if __name__=='__main__':
	...
	plt.title('Plot of the normal distibution pdf, cdf and a histogram of ' \
		'1000 values')
	plt.legend()
	plt.show()
